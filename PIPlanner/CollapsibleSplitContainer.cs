...
namespace PIPlanner
{
    ...
    public class CollapsibleSplitContainer : SplitContainer, ISupportInitialize
    {
        ...
        private Cursor pointer = new Cursor(new MemoryStream(Properties.Resources.pointer));
        private Cursor pointer_no = new Cursor(new MemoryStream(Properties.Resources.pointer_no));
        #endregion
        ...
        {
            Color backcolor = Color.LightGray; //this.BackColor;
